...
class JobSchedulerManager {
    ...
    init {
        ...
        props["org.quartz.scheduler.instanceName"] = "RentScheduler"
        props["org.quartz.threadPool.threadCount"] = "3"

        props["org.quartz.dataSource.mySql.driver"] = Constants.driver
        props["org.quartz.dataSource.mySql.URL"] = Constants.dbUrl
        props["org.quartz.dataSource.mySql.user"] = Constants.user
        props["org.quartz.dataSource.mySql.password"] = Constants.password
